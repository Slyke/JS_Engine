...
const createAtari2600AudioCard = () => {
  let container = null;
  let emu = null;
  let host = null;
  ...
  const mount = (context) => {
    ...
    const master = createCheckbox({ id: "debugger-atari-audio-enabled", label: "Sound", checked: audioEnabled() });
    ...
    for (const control of controls()) {
      ...
      const part = createCheckbox({
        id: "debugger-atari-audio-part-" + safeId(id),
...
export default createAtari2600AudioCard;
